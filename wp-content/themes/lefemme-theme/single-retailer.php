...
function showPosition(position) {
    ...
    x.innerHTML = '<iframe id="iframe-google-map" class="content" width="100%" height="215" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  src="https://www.google.com/maps/embed/v1/directions?key=AIzaSyCAiqJUkDWwO6KuPEfWZ1u8YfdHQ0BRKjc&origin=' + position.coords.latitude + '%2C' + position.coords.longitude + '&destination=<?php the_field('address'); ?>&avoid=tolls|highways" width="600" height="450" frameborder="0" style="border:0">';
}
</script>
<?php get_footer(); ?>