...
src='http://internationalprom.com/wp-content/themes/internationalprom-theme/images/pro_slider_prev_black.png'><span style='position:absolute;top:15%;font-size:13px'>BACK TO DESIGNER GALLERY</span></div></a>";     
      	    ?>
                                        ...
                                        <?php foreach( $images as $image ){ ?>
                                            <?php if ($k != 0) { ?>
	                                            <a class="simpleLens-thumbnail-wrapper" href="#" data-lens-image="<?php echo $image['url']; ?>" data-big-image="<?php echo $image['url']; ?>">
	                                                <img src="<?php $url = explode('.', $image['url']);
