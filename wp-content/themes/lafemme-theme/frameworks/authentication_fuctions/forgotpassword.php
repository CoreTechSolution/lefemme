...
<div class="commonForm">
    <form id="forms" method="post" action="">
        <div class="form-group">
            <input class="form-control" type="text" name="userid" placeholder="Registered Email Address *" />
        </div>
        <div class="form-group">
            <input type="submit" name="sendid" value="Send Request" class="btn btn-primary">
        </div>
    </form>
</div>
<script>
