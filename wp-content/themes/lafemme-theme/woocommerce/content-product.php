...
?>
<div class="col-lg-4 col-md-4 col-sm-12 pro_<?php echo get_the_ID(); ?> matchheight">
	<?php
	/**
                ...
                <div>
                    <div class="pro_img_slider" data-id="<?php echo get_the_ID(); ?>">
                        <?php if(has_post_thumbnail()) { ?>
	                        <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'thumb_349_523' ); ?>
                            <div><?php the_post_thumbnail( 'thumb_349_523' ); ?></div>
                            <!--<div><img class="lazy" data-src="<?php /*echo $image[0]; */?>"/></div>-->
                        <?php
                        } else {
                        ?>
