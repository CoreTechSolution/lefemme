...
jQuery( document ).ready( function ( $ ) {
    ...
    if ($('input#another_color_check').is(':checked')) {
        var html = $('#another_color').attr('data-html');
        $('#another_color').html(html);
        $( '#term-color1' ).wpColorPicker();
    } else {
        $('#another_color').html('');
    }

	$('input#another_color_check').on('change', function() {
        if ($(this).is(':checked')) {
            var html = $('#another_color').attr('data-html');
            $('#another_color').html(html);
            $( '#term-color1' ).wpColorPicker();
