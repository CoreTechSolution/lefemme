    ...
    switch ($col) {
        ...
        case 'seller':
            ...
            if ( $has_sub != '1' ) {
	            ...
	            $company_name = get_user_meta( $post->post_author, 'company_name', true );
	            if(empty($company_name)) {
		            $company_name = $seller->display_name;
	            }
                printf( '<a href="%s">%s</a>', admin_url( 'edit.php?post_type=shop_order&author=' . $seller->ID ), $company_name );
            }
